...
const Register = (props) => {
    ...
    const organizerRegistering = (event) => {
        ...
        axiosWithAuth()
            ...
            .then(response => console.log("registration response:", response), history.push(`/organizer/dashboard`))
            .catch(error => console.log("registration error:", error))
        history.push(`/organizer/login`)
    }
    return (
        <StyledFormContainer>
            <StyledForm onSubmit={organizerRegistering}>
